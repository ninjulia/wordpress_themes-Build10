<?php
/**
 * Widget API: WP Widget Categories Custom class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
 * MODIFIED WP Widget Categories class FOR photoGallery
 */
...
class WP_Widget_Categories_Custom extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
            //Delete title for photoGallery theme
...
/* ]]> */
            ...
            <!-- added class name to ul, added static link to all photos/home -->
			<ul class="w3-ul">
                <li><a href="<?php echo home_url( '/' ); ?>">All Photos</a></li>
				<?php
				$cat_args['title_li'] = '';
